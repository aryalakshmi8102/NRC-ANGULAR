...
console.log("option = "+JSON.stringify(option));
 ...
 admissionsdCalculation(admissionweight:any,admissionheight:any){
  ...
  if(admissionweight!=undefined && admissionheight!=undefined){
    ...
    (this.gender == 'F' && admissionweight>=1.9 && admissionweight<=24.7 && admissionheight>=45 && admissionheight<=110)){
      this.data. getAdmittedsdvalue(admissionweight,admissionheight,this.gender).subscribe(response => {
