...
console.log("searchedchilds2 = "+this.searchedchilds.uhId);
  ...
  onSubmitreAdmission(userForm:any,childForm:any,caseForm:any,detailsForm:any){
    ...
    this.data.reAdmissionfull(userForm,childForm,caseForm,detailsForm,this.searchedchilds.gender,this.currentUser.nrcUId,this.caseId,
